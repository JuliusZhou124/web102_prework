...
const displayString = `Currently, ${unfundedGames === 1 ? "1 game is" : `${unfundedGames} games are`} not yet funded.`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesDisplay = document.createElement("p");
unfundedGamesDisplay.innerHTML = displayString;
descriptionContainer.appendChild(unfundedGamesDisplay);
